...
class Teacher_State_Encoder(nn.Module):
    ...
    def __init__(self, state_size, action_size, seed, args):
        ...
        self.fc1 = nn.Linear(args.hidden_size_input+args.hidden_size_output, self.hidden_size)
...
class Student_State_Encoder(nn.Module): #This ouputs N X h
    ...
    def __init__(self, seed, args):
        ...
        self.hs_hidden_size = args.hidden_size_input #32
        self.he_hidden_size = args.hidden_size_output #32
